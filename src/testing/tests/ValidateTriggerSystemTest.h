...
struct ValidateTriggerSystemTest {
  static void execute() {
    ...
    // payload Bug: TriggerEvent component may not be implemented
    ...
    // OnCourseStart, OnCourseComplete Bug: Trigger hooks may not be defined
    ...
    // FutureAllies Bug: Targeting scopes may not be implemented
  }

  static bool validate_trigger_events() {
    ...
    // sourceEntityId asc) Bug: Event ordering may not be deterministic
  ...
  static bool validate_effect_system() {
  ...
  static bool validate_french_fries_effect() {
