...
struct ValidateDishSystemTest {
  static void execute() {
    ...
    // richness, freshness) Bug: FlavorStats component may be missing fields
  ...
  static bool validate_flavor_stats() {
  ...
  static bool validate_dish_types() {
  ...
  static bool validate_level_system() {
