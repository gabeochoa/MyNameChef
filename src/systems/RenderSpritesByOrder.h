...
struct RenderSpritesByOrder : System<afterhours::texture_manager::HasSprite, HasRenderOrder> {
  ...
  virtual void for_each_with(const Entity & /* entity */, 
    ...
    raylib::DrawTexturePro(
        sheet, hasSprite.frame, hasSprite.destination(),
        vec2{hasSprite.transform.size.x / 2.f, hasSprite.transform.size.y / 2.f},
