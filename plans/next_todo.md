...
### Task 1: Fix Effect System Test Issues
**Files**: `src/testing/tests/ValidateEffectSystemTest.h`
...
- **Validation Steps**:
  ...
  6. Commit: `git commit -m "add survivor carryover test coverage"`
- **Estimated**: 2-3 hours
...
- **Validation Steps**:
  ...
  9. Commit: `git commit -m "implement tags and SynergyCountingSystem"`
- **Estimated**: 4-6 hours

### Task 4: Implement Tier 1 Food Trigger Effects
...
- **Fun Ideas**:
  - Visual effect indicators when triggers fire (sparkles, glows)
  - Sound effects for different trigger types
  - Animation for stat boosts (numbers floating up)
- **Validation Steps**:
...
- **Validation Steps**:
  ...
  8. Commit: `git commit -m "implement BattleReport persistence with JSON serialization"`
- **Estimated**: 4-5 hours
...
- **Validation Steps**:
  ...
  9. Commit: `git commit -m "enhance replay system with seek, speed controls, and battle history"`
- **Estimated**: 6-8 hours
...
- **Validation Steps**:
  ...
  9. Commit: `git commit -m "implement set bonus effects with threshold system"`
- **Estimated**: 6-8 hours
...
- **Validation Steps**:
  ...
  9. Commit: `git commit -m "ui - enhance shop UX with prices, freeze badges, and drop highlights"`
- **Estimated**: 4-6 hours
...
### Task 9: Advanced Effect System Extensions
...
- **Validation Steps**:
  ...
  9. Commit: `git commit -m "extend EffectResolutionSystem with status effects and duration tracking"`
- **Estimated**: 10-15 hours

### Task 10: Combine Duplicates into Levels
...
- **Validation Steps**:
  ...
  9. Commit: `git commit -m "implement combine duplicates system with level scaling"`
...
**Immediate (This Week)**:
- Tier 1: Fix test issues and add test coverage (3-5 hours)
